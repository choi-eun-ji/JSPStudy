...
<%--<form name="memberFrm" action="/JSPServletBegin/getpostMethod_3.do" method="get">
또는
<form name="memberFrm" action="<%= request.getContextPath() %>/getpostMethod_3.do" method="get">--%>

<form name="memberFrm" action="<%= ctxPath %>/getpostMethod_3.do" method="get">
<%-- submit 을 하면 <%= ctxPath%>/getpostMethod_3.do 로 보내어서 처리를 요청한다.
     /JSPServletBegin/getpostMethod_3.do 은 누가 처리를 해주는지 배치서술자인 web.xml에 기술되어져 있어야 한다.
