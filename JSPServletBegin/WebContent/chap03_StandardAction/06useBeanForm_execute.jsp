...
<body>
        <!-- 같은 파일내에 없을때! --> 
	<!-- 절대경로: <form name="memberFrm" action=<%=ctxPath%> + "/chap03_StandardAction/06useBeanRegister.jsp"> --><!-- ctxPath : /JSPServletBegin -->
	
	<!-- 상대경로 -->
	<form name="memberFrm" action="06useBeanRegister.jsp"> <!-- ctxPath : /JSPServletBegin -->
		<fieldset>
